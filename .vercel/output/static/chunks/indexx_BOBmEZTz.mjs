/* empty css                         */
import { b as createComponent, d as renderTemplate, f as renderComponent } from './astro/server_C2zacUNG.mjs';
import 'kleur/colors';
import { a as $$MainLayout } from './MainLayout_hddzYu9E.mjs';
import { $ as $$HeroSection, h as heroImage, a as $$ClientsSection, b as $$About, c as $$FeaturesGeneral, f as featureImage, d as $$FeaturesNavs, s as solution1, e as solution2, g as solution3, i as $$HeroSectionAlt, j as $$FAQ, k as faqs } from './it_DU16MQ8C.mjs';

const $$Indexx = createComponent(($$result, $$props, $$slots) => {
  const avatarSrcs = [
...
}, "C:/Users/Rizan/Desktop/lovosis/src/pages/indexx.astro", void 0);

const $$file = "C:/Users/Rizan/Desktop/lovosis/src/pages/indexx.astro";
const $$url = "/indexx";

export { $$Indexx as default, $$file as file, $$url as url };
