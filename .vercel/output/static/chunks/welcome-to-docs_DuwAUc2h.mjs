...
const file = "D:/gafoor work files/lovosis/src/content/docs/es/welcome-to-docs.mdx";
...
Content.moduleId = "D:/gafoor work files/lovosis/src/content/docs/es/welcome-to-docs.mdx";
