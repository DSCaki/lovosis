...
const file = "D:/gafoor work files/lovosis/src/content/docs/es/guides/intro.mdx";
...
Content.moduleId = "D:/gafoor work files/lovosis/src/content/docs/es/guides/intro.mdx";
