...
const file = "D:/gafoor work files/lovosis/src/content/docs/de/welcome-to-docs.mdx";
...
Content.moduleId = "D:/gafoor work files/lovosis/src/content/docs/de/welcome-to-docs.mdx";
