...
const file = "D:/gafoor work files/lovosis/src/content/docs/es/guides/getting-started.mdx";
...
Content.moduleId = "D:/gafoor work files/lovosis/src/content/docs/es/guides/getting-started.mdx";
