import { a as createAstro, b as createComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent } from './astro/server_C2zacUNG.mjs';
import 'kleur/colors';
...
const $$PrimaryCTA = createComponent(($$result, $$props, $$slots) => {
  ...
  const bgColorClasses = "bg-blue-600 hover:bg-blue-600 active:bg-blue600 dark:focus:outline-none";
...
}, "C:/Users/Rizan/Desktop/lovosis/src/components/ui/buttons/PrimaryCTA.astro", void 0);
