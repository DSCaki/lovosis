/* empty css                         */
import { a as createAstro, b as createComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent, u as unescapeHTML, F as Fragment, g as renderScript, h as renderSlot } from './astro/server_C2zacUNG.mjs';
import 'kleur/colors';
import { $ as $$Icon, a as $$MainLayout } from './MainLayout_Ct9xfh3x.mjs';
import { $ as $$PrimaryCTA } from './PrimaryCTA_BOM2fr6B.mjs';
import 'clsx';
/* empty css                         */
import { $ as $$ContactIconBlock } from './ContactIconBlock_DCmC7Mq7.mjs';
...
}, "D:/gafoor work files/lovosis/src/components/ui/buttons/SecondaryCTA.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/ui/blocks/StatsGrid.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/sections/landing/About.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/sections/ContactSection.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/sections/landing/HeroSectionAlt.astro", void 0);
...
const $$ClientsSection = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderScript($$result, "D:/gafoor work files/lovosis/src/components/sections/landing/ClientsSection.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 2xl:max-w-full astro-o4xmnqps"> <!-- Title and description --> <div class="mx-auto mb-12 w-full space-y-1 text-center sm:w-1/2 lg:w-1/3 astro-o4xmnqps"> <h2 class="text-balance text-2xl font-bold leading-tight text-neutral-800 dark:text-neutral-200 sm:text-3xl fade-in-up-bounce astro-o4xmnqps"> ${title} </h2> ${subTitle && renderTemplate`<p class="text-pretty leading-tight text-neutral-600 dark:text-neutral-400 fade-in-up-bounce-delayed astro-o4xmnqps"> ${subTitle} </p>`} </div> <div class="flex flex-col items-center justify-center gap-y-2 sm:flex-row sm:gap-x-12 sm:gap-y-0 lg:gap-x-24 astro-o4xmnqps"> <div class="slider astro-o4xmnqps" style="--width: 100px; --height: 50px; --quantity: 10;"> <div class="list astro-o4xmnqps"> <div class="item astro-o4xmnqps" style="--position: 1"><img src="pictures/Brand Logo/hikvision.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 2"><img src="pictures/Brand Logo/dahua.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 3"><img src="pictures/Brand Logo/ewind.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 4"><img src="pictures/Brand Logo/Toshiba.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 5"><img src="pictures/Brand Logo/western.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 6"><img src="pictures/Brand Logo/hikvision.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 7"><img src="pictures/Brand Logo/dahua.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 8"><img src="pictures/Brand Logo/ewind.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 9"><img src="pictures/Brand Logo/Toshiba.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> <div class="item astro-o4xmnqps" style="--position: 10"><img src="pictures/Brand Logo/western.png" alt="client1" class="w-40 h-5 astro-o4xmnqps"></div> </div> </div> </div> </section>`;
}, "D:/gafoor work files/lovosis/src/components/sections/landing/ClientsSection.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/sections/features/FeaturesGeneral.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/ui/blocks/TabNav.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/ui/blocks/TabContent.astro", void 0);
...
}, "D:/gafoor work files/lovosis/src/components/ui/blocks/AccordionItem.astro", void 0);
...
const $$FAQ = createComponent(($$result, $$props, $$slots) => {
  ...
  })} </div> </div> </div> </section> <!--Import the necessary Accordion plugin--> <!--https://preline.co/plugins/html/accordion.html--> ${renderScript($$result, "D:/gafoor work files/lovosis/src/components/sections/FAQ.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/gafoor work files/lovosis/src/components/sections/FAQ.astro", void 0);
...
const heroImage = new Proxy({"src":"/_astro/hero-image.DRPoHq2O.avif","width":4067,"height":2576,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/gafoor work files/lovosis/src/images/hero-image.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("D:/gafoor work files/lovosis/src/images/hero-image.avif");
							return target[name];
						}
					});
...
const featureImage = new Proxy({"src":"/_astro/features-image.BEGIe8fA.avif","width":4375,"height":2369,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/gafoor work files/lovosis/src/images/features-image.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("D:/gafoor work files/lovosis/src/images/features-image.avif");
							return target[name];
						}
					});
...
const solution1 = new Proxy({"src":"/_astro/surveillance.BiDjsID-.webp","width":2452,"height":1375,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/gafoor work files/lovosis/src/images/surveillance.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("D:/gafoor work files/lovosis/src/images/surveillance.webp");
							return target[name];
						}
					});
...
const solution2 = new Proxy({"src":"/_astro/fabrication.BWDM6AVi.webp","width":3000,"height":2000,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/gafoor work files/lovosis/src/images/fabrication.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("D:/gafoor work files/lovosis/src/images/fabrication.webp");
							return target[name];
						}
					});
...
const solution3 = new Proxy({"src":"/_astro/it.fxK2X-Lu.webp","width":2397,"height":1600,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/gafoor work files/lovosis/src/images/it.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("D:/gafoor work files/lovosis/src/images/it.webp");
							return target[name];
						}
					});
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ] })} ${renderComponent($$result2, "FeaturesGeneral", $$FeaturesGeneral, { "title": "Meeting Industry Demands", "subTitle": "Lovosis, a leading custom fabrication and surveillance solution provider in Dubai, partners with top brands like Hikvision, Dahua, EWIND, Western Digital, and Toshiba. We offer cutting-edge security systems featuring advanced technology for optimal protection and monitoring. Trust Lovosis for innovative and reliable surveillance solutions tailored to your needs.", "src": featureImage, "alt": "Lovosis Brands" })}  ${renderComponent($$result2, "FeaturesNavs", $$FeaturesNavs, { "title": `<span class="text-blue-600 dark:text-teal-600">Lovosis</span>'s offerings solution to perfectly suit your Needs.`, "tabs": [
    {
...
}, "D:/gafoor work files/lovosis/src/pages/index.astro", void 0);

const $$file = "D:/gafoor work files/lovosis/src/pages/index.astro";
const $$url = "";
